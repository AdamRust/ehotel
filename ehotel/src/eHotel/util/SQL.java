...
public final class SQL {
	...
	// Room queries
	public static final String GET_ROOM_FROM_ID = "SELECT * FROM ehotel.room WHERE room_id=? AND hotel_id=?";
	...
	// Hotel queries
	public static final String GET_HOTEL_FROM_ID = "SELECT * FROM ehotel.hotel WHERE hotel_id=? AND brand_id=?";
	// Hotel Brand queries
